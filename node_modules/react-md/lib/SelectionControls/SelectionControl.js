  ...
  var SelectionControl = function (_PureComponent) {
    ...
    function SelectionControl(props) {
      ...
      _this._getIcon = function () {
        ...
        return _react2.default.cloneElement(_this.props[prefix], { inherit: true });
      };
    ...
    _createClass(SelectionControl, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['id', 'style', 'className', 'inline', 'type', 'name', 'value', 'disabled', 'labelBefore', 'tabIndex', 'inkDisabled', 'disabledInteractions', 'aria-label', 'label', 'checked', 'onChange', 'tooltip', 'checkedCheckboxIcon', 'uncheckedCheckboxIcon', 'checkedRadioIcon', 'uncheckedRadioIcon', '__superSecreteProp', 'checkedIcon', 'uncheckedIcon', 'checkedRadioIconChildren', 'checkedRadioIconClassName', 'uncheckedRadioIconChildren', 'uncheckedRadioIconClassName', 'checkedCheckboxIconChildren', 'checkedCheckboxIconClassName', 'uncheckedCheckboxIconChildren', 'uncheckedCheckboxIconClassName']);
