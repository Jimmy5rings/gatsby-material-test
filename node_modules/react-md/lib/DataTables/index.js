(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './DataTable', './TableHeader', './TableBody', './TableRow', './TableColumn', './EditDialogColumn', './TablePagination', './TableCardHeader', './SelectFieldColumn', './MenuButtonColumn', './DropdownMenuColumn'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./DataTable'), require('./TableHeader'), require('./TableBody'), require('./TableRow'), require('./TableColumn'), require('./EditDialogColumn'), require('./TablePagination'), require('./TableCardHeader'), require('./SelectFieldColumn'), require('./MenuButtonColumn'), require('./DropdownMenuColumn'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.DataTable, global.TableHeader, global.TableBody, global.TableRow, global.TableColumn, global.EditDialogColumn, global.TablePagination, global.TableCardHeader, global.SelectFieldColumn, global.MenuButtonColumn, global.DropdownMenuColumn);
    global.index = mod.exports;
  }
})(this, function (exports, _DataTable2, _TableHeader2, _TableBody2, _TableRow2, _TableColumn2, _EditDialogColumn2, _TablePagination2, _TableCardHeader2, _SelectFieldColumn2, _MenuButtonColumn2, _DropdownMenuColumn2) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.DropdownMenuColumn = exports.MenuButtonColumn = exports.SelectFieldColumn = exports.TableCardHeader = exports.TablePagination = exports.EditDialogColumn = exports.TableColumn = exports.TableRow = exports.TableBody = exports.TableHeader = exports.DataTable = undefined;
