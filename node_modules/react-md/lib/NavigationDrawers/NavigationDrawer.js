(function (global, factory) {
  ...
  NavigationDrawer.propTypes = {
    ...
    temporaryIconChildren: (0, _deprecated2.default)(_propTypes2.default.node, 'Use the `temporaryIcon` prop instead'),
    temporaryIconClassName: (0, _deprecated2.default)(_propTypes2.default.string, 'Use the `temporaryIcon` prop instead.'),
    persistentIconChildren: (0, _deprecated2.default)(_propTypes2.default.node, 'Use the `persistentIcon` prop instead'),
